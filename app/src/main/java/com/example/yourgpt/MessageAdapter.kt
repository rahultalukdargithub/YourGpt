...
class MessageAdapter(private val context: Activity, private val messageList: MutableList<Message>) : RecyclerView.Adapter<MessageAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val chatView = LayoutInflater.from(context).inflate(R.layout.chat_item, parent, false)
